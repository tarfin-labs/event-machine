...
| D6 | **The `1000`/`200` ceilings are literals in seven declarations** rather than `config/machine.php`, unlike `max_transition_depth`. | Each is overridable at the point it matters; config-backing is ergonomics, not correctness. |
