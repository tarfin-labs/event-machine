# Release Notes — 9.14.0 Testing DX Improvements

> Source for the 9.14.0 GitHub release body (`spec/9.14.0-testing-dx-improvements.md`).

Requires no consumer changes for existing tests (see Backward Compatibility). To use the new APIs in tarfin-core, bump the package requirement to `^9.14`.
