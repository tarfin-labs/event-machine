...
- [States and Transitions](/understanding/states-and-transitions) - Deep dive into the core model
- [Actions](/behaviors/actions) - All the ways to execute side effects
- [Guards](/behaviors/guards) - Conditional logic and validation
- [Laravel Integration](/laravel/model-integration) - Full Eloquent integration
